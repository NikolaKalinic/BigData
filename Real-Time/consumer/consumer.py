...
query_1 = query_1.withWatermark("timestamp","10 minutes").groupBy("location_name",window("timestamp", "1 hour", "15 minutes"),).agg(avg("temp_c").alias("avg_temp_c"))
...
query_2 = query_2.withWatermark("timestamp", "10 minutes").groupBy("location_name", window("timestamp", "1 hour", "15 minutes")).agg(max("wind_kph").alias("max_wind_kph"))
...
query_3 = query_3.withWatermark("timestamp", "10 minutes").groupBy("location_name", window("timestamp", "1 hour", "15 minutes")).agg(sum("precip_mm").alias("total_precip_mm"))
